...
describe('Test Pokemon.ts', () => {
    ...
    const salameche: Pokemon = new Pokemon("salameche", 10, "feu", 10, 20, 30, 40, 30, 60, 40, [new Competence("flammeche", "special", 30, "feu", 100, 20)]);
    ...
    test('grolem kill salamech', () => {
        grolem.attaquePokemon(salameche, grolem.competences[0])
        expect(salameche.pv).toBe(0);
    })
